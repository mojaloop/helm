...
*/}}
{{- define "k6-tests.volumePermissions.image" -}}
...
*/}}
{{- define "k6-tests.imagePullSecrets" -}}
...
*/}}
{{- define "k6-tests.serviceAccountName" -}}
...
*/}}
{{- define "k6-tests.validateValues" -}}
{{- $messages := list -}}
