...
2. central-ledger: v16.3.1 -> **v17.0.0** ([Compare](https://github.com/mojaloop/central-ledger/compare/v16.3.1...v17.0.0))
...
2. central-ledger - https://github.com/mojaloop/central-ledger/releases/tag/v17.0.0
