...
9. **mojaloop/#2538:** FSPIOP API version negotiation not handled - Bulk-api-adapter ([xxxx](xxxx), closes[mojaloop/#xxxx](https://github.com/mojaloop/project/issues/2538))
